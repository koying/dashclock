...
public class WeatherSettingsActivity extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(R.drawable.ic_extension_weatherosm);
    ...
    protected void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference(WeatherOsmExtension.PREF_WEATHER_UNITS));
        //bindPreferenceSummaryToValue(findPreference(WeatherOsmExtension.PREF_WEATHER_SHORTCUT));
    }
